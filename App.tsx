      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col relative z-10 h-full">
                                            ...
                                            {translationState && translationState.visible && (
                                                <div className="mt-3 pt-3 border-t border-white/10 relative z-10 animate-slide-up-fade">
                                                    ...
                                                    {translationState.loading ? (
                                                        ...
                                                        <div className="text-sm font-light text-zinc-300 leading-relaxed italic whitespace-pre-wrap" dir="auto">
            ...
            {activeSession && !manageMode && (
                <div className="fixed top-16 md:top-20 right-4 md:right-8 z-30 flex flex-col gap-3">
                    <button
